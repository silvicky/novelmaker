...
public class VariableDeclaration extends NonTerminal
{
    ...
    public List<AbstractToken> lookup(AbstractToken next, AbstractToken second)
    {
        ...
        if(operatorToken.type == OperatorType.COMMA||operatorToken.type==OperatorType.SEMICOLON)
        {
            ...
            ret.add(residue);
            ret.add(new AppendCodeOperation(this,new AssignNumberCode(nid,0)));
        ...
        else if(operatorToken.type==OperatorType.EQUAL)
        {
            ...
            {
                nid=registerVariable(id);
                VariableDeclarationResidue residue=new VariableDeclarationResidue(null);
                ret.add(new AppendCodeSeqOperation(this,residue));
                ret.add(residue);
                NumberValue numberValue=new NumberValue(nid);
                ret.add(new AppendCodeSeqOperation(this,numberValue));
                ret.add(numberValue);
            }
            else
            {
